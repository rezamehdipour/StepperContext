...
const Contact = (props) => {
	...
	const handleEmailRealtime = (e) => {
		...
		email === "" ? setData(["email", false]) : setData(["email", email.toLowerCase()]);
	};
	...
	const handleAddressRealtime = (e) => {
		...
		address === "" ? setData(["address", false]) : setData(["address", address]);
	};
	...
	const handleWebsiteRealtime = (e) => {
		...
		website === "" ? setData(["website", false]) : setData(["website", website.toLowerCase()]);
	};
