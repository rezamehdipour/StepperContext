...
const Identity = (props) => {
	...
	const handleContinentRealtime = (e) => {
		...
		continent === "" ? setData(["continent", false]) : setData(["continent", continent]);
	};
	...
	const handleCountryRealtime = (e) => {
		...
		country === "" ? setData(["country", false]) : setData(["country", country]);
	};
		...
		if (enteredNationalCardId.length < 11) {
			if (regex.test(enteredNationalCardId) || enteredNationalCardId === "") {
				if (enteredNationalCardId === "") {
					setData(["nationalCardId", false]);
				} else {
					setData(["nationalCardId", enteredNationalCardId]);
				}
			} else {
