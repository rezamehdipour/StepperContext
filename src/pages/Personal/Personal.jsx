...
const Personal = (props) => {
	...
	useUpdateEffect(() => setTimeout(() => setFirstNameError(""), 5000), [firstNameError]);

	const [lastNameError, setLastNameError] = useState(""); // Lastname Error
	useUpdateEffect(() => setTimeout(() => setLastNameError(""), 5000), [lastNameError]);

	const [genderError, setGenderError] = useState(""); // Gender Error
	useUpdateEffect(() => setTimeout(() => setGenderError(""), 5000), [genderError]);

	const [birthDateError, setBirthDateError] = useState(""); // Birthdate Error
	useUpdateEffect(() => setTimeout(() => setBirthDateError(""), 5000), [birthDateError]);
