...
const Authentication = (props) => {
	...
	const handleUsernameRealtime = (e) => {
		...
		username === "" ? setData(["username", false]) : setData(["username", username]);
	};
	...
	const handlePasswordRealtime = (e) => {
		...
		password === "" ? setData(["password", false]) : setData(["password", password]);
	};
	...
	const handleFavoriteColorRealtime = (e) => {
		...
		favoriteColor === "" ? setData(["favoriteColor", false]) : setData(["favoriteColor", favoriteColor]);
	};
